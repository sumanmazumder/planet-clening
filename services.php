<?php include 'includes/header.php'; ?>
        ...
        <!--Start Services Two-->
        <section class="services-two services-two--services">
            <div class="services-two__pattern"
                style="background-image: url(assets/images/pattern/services-v2-pattern.png);"></div>
            <div class="container">
                <div class="row">
