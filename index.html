...
<head>
    ...
    <title> Home || Planet Clening </title>
    <!-- favicons Icons -->
                    ...
                    <div class="main-header-one__top-inner">
                        <ul class="header-style1__contact">
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="tel:+14038281588">+1 (403) 828-1588</a></p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:info@planetcleaning.ca">info@planetcleaning.ca</a></p>
                                </div>
                            </li>
                        </ul>
...
<!-- <?php include 'includes/header.php'; ?> -->
            ...
            <div class="main-slider__carousel owl-carousel owl-theme">
                ...
                <div class="main-slider-one__single">
                    <div class="main-slider-one__bg"
                        style="background-image: url(assets/images/slider/slider-v1-img1.jpg);"></div>
                    <div class="container">
                ...
                <div class="main-slider-one__single">
                    <div class="main-slider-one__bg"
                        style="background-image: url(assets/images/slider/slider-v1-img2.jpg);"></div>
                    <div class="container">
                        <div class="main-slider-one__content">
                            <div class="tagline">
                                <span>Welcome to Cleanin.</span>
                ...
                <div class="main-slider-one__single">
                    <div class="main-slider-one__bg"
                        style="background-image: url(assets/images/slider/slider-v1-img3.jpg);"></div>
                    <div class="container">
                        <div class="main-slider-one__content">
                            <div class="tagline">
                                <span>Welcome to Cleanin.</span>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="contact-one__form">
                                <form class="contact-form-validated contact-one__form-box"
                                    action="https://unicktheme.com/2025/cleanin/main-html/assets/inc/sendemail.php" method="post" novalidate="novalidate">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                            <div class="input-box">
                                            ...
                                            <div class="input-box">
                                                <div class="select-box">
                                                    <select class="selectmenu wide">
                                                        <option>Bank Cleaning</option>
                                                        <option>Parking lot line painting</option>
                                                        <option>Parking Lot Cleaning</option>
                                                        <option>Carpet Steam Cleaning</option>
                                                        <option>Move in & Move Out Elevator</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="contact-one__contact-info">
                                ...
                                <ul class="contact-one__contact-info-list">
                                    <li class="contact-one__contact-info-list-item">
                                        ...
                                        <div class="text-box">
                                            <p>2323 32 Ave NE Suite 265, Calgary, AB T2E 6Z3</p>
                                        </div>
                                    </li>
        ...
        <section class="testimonial-one">
            <div class="shape1"><img src="assets/images/shapes/testimonial-v1-shape1.png" alt=""></div>
            <div class="container">
                <div class="sec-title sec-title-animation animation-style2">
                    <div class="sec-title__tagline">
                        <div class="icon-box">
        ...
        <section class="why-choose-one">
            ...
            <div class="shape3 scale"><img src="assets/images/shapes/why-choose-v1-shape1.png" alt=""></div>
            <div class="shape4 float-bob-x"><img src="assets/images/shapes/why-choose-v1-shape1.png" alt=""></div>
            <div class="shape5 float-bob-y"><img src="assets/images/shapes/why-choose-v1-shape1.png" alt=""></div>
            <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="why-choose-one__single-tab-img">
                                                    <div class="inner">
                                                        <img src="assets/images/resources/why-choose-v1-img1.jpg"
                                                            alt="#">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="why-choose-one__single-tab-inner">
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="why-choose-one__single-tab-img">
                                                    <div class="inner">
                                                        <img src="assets/images/resources/why-choose-v1-img2.jpg"
                                                            alt="#">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="why-choose-one__single-tab-inner">
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="why-choose-one__single-tab-img">
                                                    <div class="inner">
                                                        <img src="assets/images/resources/why-choose-v1-img3.jpg"
                                                            alt="#">
                                                    </div>
                                                </div>
                                            </div>
        ...
        <footer class="site-footer">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  wow fadeInUp" data-wow-delay=".1s">
                            <div class="footer-widget__single footer-widget__services">
                                ...
                                <ul class="footer-widget__services-list">
                                    <li><a href="house-cleaning.html"><span class="icon-right-chevron"></span>Home</a></li>
                                    <li><a href="about.html"><span class="icon-chevron"></span>About Us</a></li>
                                    <li><a href="team.html"><span class="icon-right-chevron"></span>Team</a>
                                    </li>
                                    <li><a href="blog.html"><span class="icon-right-chevron"></span>Blog</a></li>
                                    <li><a href="contact-us.html"><span class="icon-right-chevron"></span>Contact us</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer__bottom-inner site-footer__copyright text-center">
                                <!-- <div class="site-footer__copyright "> -->
                                    <p>Copyright &copy; 2025 <a href="index.html">Cleanin</a>. All Rights Reserved.</p>
                                <!-- </div> -->
                            </div>
                        </div>
                    </div>
